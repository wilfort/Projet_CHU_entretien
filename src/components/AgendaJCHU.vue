  ...
  <div id="agendaChu">
    <div class="center grid">
      <b-row>
        ...
        <b-row v-for='entry in rdvList' :key='entry.id' v-show="entry.hopital=='CHU' && !entry.annule && dateJ.toLocaleDateString()==entry.date"><!-- v-show condition hopital, date et annulation -->
          <b-col cols="3">
            <b-row>
              <b-col cols="2">
                {{entry['heure']}}
